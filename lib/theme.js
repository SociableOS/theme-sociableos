...
library.init = async function (params) {
	...
	routeHelpers.setupAdminPageRoute(router, '/admin/plugins/theme-sociableos', [], controllers.renderAdminPage);
...
library.addAdminNavigation = async function (header) {
	header.plugins.push({
		route: '/plugins/theme-sociableos',
		icon: 'fa-paint-brush',
		name: 'Sociable OS Theme',
	});
	return header;
};
