...
<div class="tags d-flex flex-column gap-2 px-lg-12">
	<div class="d-flex border-bottom py-2 m-0 sticky-top acp-page-main-header align-items-center justify-content-between flex-wrap gap-2">
		<div class="">
			<h4 class="fw-bold tracking-tight mb-0">Card Builder</h4>
		</div>
	...
	<div id="carouselExample" class="well row card-picker">
		<div class="col">
			<div class="card" style="width: 10rem;">
				<img src="/assets/plugins/nodebb-theme-sociableos/assets/6.jpg" class="card-img-top" alt="...">
				<div class="card-body">
					<h5 class="card-title">Make it Rain</h5>
					<p class="card-text">Make it rain in your friend's game!</p>
				</div>
			</div>
		</div>
		<div class="col">
			<div class="card" style="width: 10rem;">
				<img src="/assets/plugins/nodebb-theme-sociableos/assets/categories/bestbuy.png" class="card-img-top" alt="...">
				<div class="card-body">
					<h5 class="card-title">Best Buy</h5>
					<p class="card-text">Send a coupon for a friend to redeem!</p>
				</div>
			</div>
		</div>
		<div class="col">
			<div class="card" style="width: 10rem;">
				<img src="/assets/plugins/nodebb-theme-sociableos/assets/categories/starbucks.png" class="card-img-top" alt="...">
				<div class="card-body">
					<h5 class="card-title">Coffee Date</h5>
					<p class="card-text">Give 20% off at Starbucks coupon!</p>
				</div>
			</div>
		</div>
		<div class="col">
			<div class="card" style="width: 10rem;">
				<img src="/assets/plugins/nodebb-theme-sociableos/assets/11.jpg" class="card-img-top" alt="...">
				<div class="card-body">
					<h5 class="card-title">Give Reputation</h5>
					<p class="card-text">Gift a friend 10 SociableOS points!</p>
				</div>
			</div>
		</div>
		<div class="col">
			<div class="card" style="width: 10rem;">
				<img src="/assets/plugins/nodebb-theme-sociableos/assets/categories/diablo2.png" class="card-img-top" alt="...">
				<div class="card-body">
					<h5 class="card-title">Legendary Skin</h5>
					<p class="card-text">Trade a card to earn a limited edition skin!</p>
				</div>
			</div>
		</div>
	</div>
						...
						<div class="d-flex gap-1 mb-3 flex-wrap">
							<form class="main d-flex gap-1 flex-wrap">
								<div class="card card-body m-0 if-block border-info border border-2">
									<label class="form-label" for="condition-if-users">If</label>
